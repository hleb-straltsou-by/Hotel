...
public class EmailService {
    ...
    /**
     * sends email using velocity engine and mail sender
     * @param templateName - name of template for email
     * @param model - contains settings and information of email
     * @return true - sending was success
     *         false - sending was unsuccessful
     */
